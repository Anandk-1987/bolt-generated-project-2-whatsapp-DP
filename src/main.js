document.addEventListener('DOMContentLoaded', () => {
    ...
    if (file && file.type.startsWith('image/')) {
      ...
      reader.onload = (e) => {
        ...
        img.onload = () => {
          ...
          // Only enable share button if Web Share API is supported
          shareBtn.disabled = !(navigator.share && navigator.canShare);
          processImage(img);
        };
  ...
  shareBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        if (navigator.share && navigator.canShare({ files: [file] })) {
          ...
          if (navigator.share) {
            try {
              ...
              if (err.name !== 'AbortError') {
                console.error('Error sharing:', err);
                alert('Unable to share. You can download the image instead.');
              }
            }
          } else {
      ...
      alert('Unable to prepare image for sharing. You can download it instead.');
    }
  });
